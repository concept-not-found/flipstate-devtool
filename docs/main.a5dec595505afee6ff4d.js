...
var Checkbox = /*#__PURE__*/(0, _preactEmotion2.default)('input', {
  target: 'e19s9e1b3'
})();

var LabelText = /*#__PURE__*/(0, _preactEmotion2.default)('span', {
  target: 'e19s9e1b4'
})('color:', function (_ref) {
  var disabled = _ref.disabled;
  return disabled ? '#9b9b9b' : 'inherit';
});
...
var StateContainer = /*#__PURE__*/(0, _preactEmotion2.default)('div', {
  target: 'e19s9e1b6'
})('padding:4px;font-family:"Lucida Console",Monaco,monospace;white-space:pre;border:', function (_ref2) {
...
var DevToolState = addState('DevTool', {
  ...
  udpateAddressBarUrl: function udpateAddressBarUrl(state, _ref4) {
    var addressBarUrl = _ref4.target.value;
